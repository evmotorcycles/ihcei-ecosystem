...
class NERE:
    ...
    def reason_ethically(self, policy: str, g_ij_zakat_flow: float = 0.5) -> dict:
        ...
        agency_delta = -1 if any(word in policy.lower() for word in ["mandate", "restrict", "force"]) else +1
        ...
        response = {
            ...
            "agency_delta": "Positive (Sovereignty Enhancing)" if agency_delta > 0 else "Negative (Hoarding/Pharaoh Filter)",
